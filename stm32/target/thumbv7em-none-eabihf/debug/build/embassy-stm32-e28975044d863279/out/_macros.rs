...
macro_rules! foreach_interrupt {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_interrupt_inner!((RNG,rng,RNG,GLOBAL,HASH_RNG));
        ...
        __foreach_interrupt_inner!((TIM12,timer,TIM_GP16,BRK,TIM8_BRK_TIM12));
        __foreach_interrupt_inner!((TIM12,timer,TIM_GP16,CC,TIM8_BRK_TIM12));
        __foreach_interrupt_inner!((TIM12,timer,TIM_GP16,COM,TIM8_BRK_TIM12));
        __foreach_interrupt_inner!((TIM12,timer,TIM_GP16,TRG,TIM8_BRK_TIM12));
        __foreach_interrupt_inner!((TIM12,timer,TIM_GP16,UP,TIM8_BRK_TIM12));
        __foreach_interrupt_inner!((TIM13,timer,TIM_GP16,BRK,TIM8_UP_TIM13));
        __foreach_interrupt_inner!((TIM13,timer,TIM_GP16,CC,TIM8_UP_TIM13));
        __foreach_interrupt_inner!((TIM13,timer,TIM_GP16,COM,TIM8_UP_TIM13));
        __foreach_interrupt_inner!((TIM13,timer,TIM_GP16,TRG,TIM8_UP_TIM13));
        __foreach_interrupt_inner!((TIM13,timer,TIM_GP16,UP,TIM8_UP_TIM13));
        __foreach_interrupt_inner!((TIM14,timer,TIM_GP16,BRK,TIM8_TRG_COM_TIM14));
        __foreach_interrupt_inner!((TIM14,timer,TIM_GP16,CC,TIM8_TRG_COM_TIM14));
        __foreach_interrupt_inner!((TIM14,timer,TIM_GP16,COM,TIM8_TRG_COM_TIM14));
        __foreach_interrupt_inner!((TIM14,timer,TIM_GP16,TRG,TIM8_TRG_COM_TIM14));
        __foreach_interrupt_inner!((TIM14,timer,TIM_GP16,UP,TIM8_TRG_COM_TIM14));
        __foreach_interrupt_inner!((TIM15,timer,TIM_GP16,BRK,TIM15));
        __foreach_interrupt_inner!((TIM15,timer,TIM_GP16,CC,TIM15));
        __foreach_interrupt_inner!((TIM15,timer,TIM_GP16,COM,TIM15));
        __foreach_interrupt_inner!((TIM15,timer,TIM_GP16,TRG,TIM15));
        __foreach_interrupt_inner!((TIM15,timer,TIM_GP16,UP,TIM15));
        ...
        __foreach_interrupt_inner!((WWDG1,wwdg,WWDG,RST,WWDG_RST));
        __foreach_interrupt_inner!((WWDG2,wwdg,WWDG,GLOBAL,WWDG));
        __foreach_interrupt_inner!((WWDG2,wwdg,WWDG,RST,WWDG));
        ...
        __foreach_interrupt_inner!((CM7_SEV));
        __foreach_interrupt_inner!((CM4_SEV));
        ...
        __foreach_interrupt_inner!((CRYP));
        __foreach_interrupt_inner!((HASH_RNG));
        ...
        __foreach_interrupt_inner!((HSEM2));
...
macro_rules! foreach_peripheral {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_peripheral_inner!((iwdg,IWDG2));
        ...
        __foreach_peripheral_inner!((wwdg,WWDG2));
    };
}#[allow(unused)]
...
macro_rules! foreach_dma_channel {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_dma_channel_inner!((DMA1_CH0,DMA1,dma,0,0,{dmamux: DMAMUX1, dmamux_channel: 0}));
        __foreach_dma_channel_inner!((DMA1_CH1,DMA1,dma,1,1,{dmamux: DMAMUX1, dmamux_channel: 1}));
        __foreach_dma_channel_inner!((DMA1_CH2,DMA1,dma,2,2,{dmamux: DMAMUX1, dmamux_channel: 2}));
        __foreach_dma_channel_inner!((DMA1_CH3,DMA1,dma,3,3,{dmamux: DMAMUX1, dmamux_channel: 3}));
        __foreach_dma_channel_inner!((DMA1_CH4,DMA1,dma,4,4,{dmamux: DMAMUX1, dmamux_channel: 4}));
        __foreach_dma_channel_inner!((DMA1_CH5,DMA1,dma,5,5,{dmamux: DMAMUX1, dmamux_channel: 5}));
        __foreach_dma_channel_inner!((DMA1_CH6,DMA1,dma,6,6,{dmamux: DMAMUX1, dmamux_channel: 6}));
        __foreach_dma_channel_inner!((DMA1_CH7,DMA1,dma,7,7,{dmamux: DMAMUX1, dmamux_channel: 7}));
        __foreach_dma_channel_inner!((DMA2_CH0,DMA2,dma,0,8,{dmamux: DMAMUX1, dmamux_channel: 8}));
        __foreach_dma_channel_inner!((DMA2_CH1,DMA2,dma,1,9,{dmamux: DMAMUX1, dmamux_channel: 9}));
        __foreach_dma_channel_inner!((DMA2_CH2,DMA2,dma,2,10,{dmamux: DMAMUX1, dmamux_channel: 10}));
        __foreach_dma_channel_inner!((DMA2_CH3,DMA2,dma,3,11,{dmamux: DMAMUX1, dmamux_channel: 11}));
        __foreach_dma_channel_inner!((DMA2_CH4,DMA2,dma,4,12,{dmamux: DMAMUX1, dmamux_channel: 12}));
        __foreach_dma_channel_inner!((DMA2_CH5,DMA2,dma,5,13,{dmamux: DMAMUX1, dmamux_channel: 13}));
        __foreach_dma_channel_inner!((DMA2_CH6,DMA2,dma,6,14,{dmamux: DMAMUX1, dmamux_channel: 14}));
        __foreach_dma_channel_inner!((DMA2_CH7,DMA2,dma,7,15,{dmamux: DMAMUX1, dmamux_channel: 15}));
        __foreach_dma_channel_inner!((BDMA_CH0,BDMA,bdma,0,0,{dmamux: DMAMUX2, dmamux_channel: 0}));
        __foreach_dma_channel_inner!((BDMA_CH1,BDMA,bdma,1,1,{dmamux: DMAMUX2, dmamux_channel: 1}));
        __foreach_dma_channel_inner!((BDMA_CH2,BDMA,bdma,2,2,{dmamux: DMAMUX2, dmamux_channel: 2}));
        __foreach_dma_channel_inner!((BDMA_CH3,BDMA,bdma,3,3,{dmamux: DMAMUX2, dmamux_channel: 3}));
        __foreach_dma_channel_inner!((BDMA_CH4,BDMA,bdma,4,4,{dmamux: DMAMUX2, dmamux_channel: 4}));
        __foreach_dma_channel_inner!((BDMA_CH5,BDMA,bdma,5,5,{dmamux: DMAMUX2, dmamux_channel: 5}));
        __foreach_dma_channel_inner!((BDMA_CH6,BDMA,bdma,6,6,{dmamux: DMAMUX2, dmamux_channel: 6}));
        __foreach_dma_channel_inner!((BDMA_CH7,BDMA,bdma,7,7,{dmamux: DMAMUX2, dmamux_channel: 7}));
    };
}#[allow(unused)]
